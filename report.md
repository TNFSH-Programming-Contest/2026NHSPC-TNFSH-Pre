...
| contest_name |  [:x:](pA/problem.json) | [:x:](pB/problem.json) | [:x:](pC/problem.json) | [:x:](pD/problem.json) | [:x:](pE/problem.json) | [:white_check_mark:](pF/problem.json)<br>115 學年度資訊學科能力競賽臺南一中校內初選 |
...
| name |  [:x:](pA/problem.json) | [:x:](pB/problem.json) | [:x:](pC/problem.json) | [:x:](pD/problem.json) | [:x:](pE/problem.json) | [:white_check_mark:](pF/problem.json)<br>Seed_Manacher |
| title |  [:x:](pA/problem.json) | [:x:](pB/problem.json) | [:x:](pC/problem.json) | [:x:](pD/problem.json) | [:x:](pE/problem.json) | [:white_check_mark:](pF/problem.json)<br>種馬拉車 |
