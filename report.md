...
| C | 3<br>$NM = 1$ | 5<br>$1 \le Q \le 10$ | 5<br>$N = 1$ | 7<br>$N=2$ | 7<br>球檯內部只會有 `.` 與 `/` 或 `\` 其中之一 | 7<br>所有詢問都從上方進入 | 8<br>每一列最多有一個 `\` 或 `/` | 7<br>$1 \le N, M \le 10, 1 \le Q \le 10$ | 8<br>$1 \le N, M \le 1000, 1 \le Q \le 100$，輸入的字元僅包含 `.` | 18<br>$1 \le N, M \le 200, 1 \le Q \le 1000$ | 25<br>無額外限制 |
